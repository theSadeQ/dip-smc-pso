"""
Robustness tests for Hybrid Adaptive STA-SMC controller.
...
of mode-switching logic and finite-time convergence under fault conditions.
"""
...
class TestHybridSMCRobustness:
    """Robustness test suite for Hybrid Adaptive STA-SMC."""
    ...
    def test_sensor_noise_mild(
        ...
        """Test Hybrid SMC with mild sensor noise (SNR=50dB)."""
    ...
    def test_sensor_noise_moderate(
        ...
        """Test Hybrid SMC with moderate sensor noise (SNR=30dB)."""
    ...
    def test_sensor_noise_severe(
        ...
        """Test Hybrid SMC with severe sensor noise (SNR=10dB)."""
    ...
    def test_actuator_saturation_mild(
        ...
        """Test Hybrid SMC with mild actuator saturation (80%)."""
    ...
    def test_actuator_saturation_moderate(
        ...
        """Test Hybrid SMC with moderate actuator saturation (60%)."""
    ...
    def test_actuator_saturation_severe(
        ...
        """Test Hybrid SMC with severe actuator saturation (40%)."""
    ...
    def test_parameter_uncertainty_mild(
        ...
        """Test Hybrid SMC with mild parameter uncertainty (±5%)."""
        # For Hybrid SMC, parameter errors in adaptation gains should be tolerated
        ...
        faulty_controller = create_controller('hybrid_adaptive_sta_smc', gains=corrupted_gains.tolist())
    ...
    def test_parameter_uncertainty_moderate(
        ...
        """Test Hybrid SMC with moderate parameter uncertainty (±10%)."""
        nominal_gains = np.array([10.0, 5.0, 8.0, 3.0, 15.0, 2.0])
    ...
    def test_parameter_uncertainty_severe(
        ...
        """Test Hybrid SMC with severe parameter uncertainty (±20%)."""
        nominal_gains = np.array([10.0, 5.0, 8.0, 3.0, 15.0, 2.0])
    ...
    def test_combined_faults_mild(
        ...
        """Test Hybrid SMC with combined mild faults."""
    ...
    def test_combined_faults_moderate(
        ...
        """Test Hybrid SMC with combined moderate faults."""
    ...
    def test_combined_faults_severe(
        ...
        """Test Hybrid SMC with combined severe faults."""
    ...
    def test_compute_robustness_index(
        ...
        assert ri > 0.5, "Hybrid SMC should have decent robustness (RI > 0.5)"
