...
Usage:
    python .project/dev_tools/add_navigation_footers.py --dry-run
    python .project/dev_tools/add_navigation_footers.py --apply
...
Examples:
  ...
  python add_navigation_footers.py
    ...
    if dry_run and modified_count > 0:
        ...
        print("       python .project/dev_tools/add_navigation_footers.py --apply\n")
