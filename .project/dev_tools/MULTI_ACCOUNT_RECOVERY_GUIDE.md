...
import json
progress = json.load(open('.artifacts/<task>_<agent>_progress.json'))
...
python .project/dev_tools/cleanup_test_checkpoints.py

# Actually delete test checkpoints
python .project/dev_tools/cleanup_test_checkpoints.py --execute
```
...
python .project/dev_tools/cleanup_test_checkpoints.py --all --execute
```
...
### Recovery Tools
- **Main recovery script:** `.project/dev_tools/recover_project.sh`
- **Checkpoint analyzer:** `.project/dev_tools/analyze_checkpoints.py`
- **Cleanup script:** `.project/dev_tools/cleanup_test_checkpoints.py`
- **Task wrapper:** `.project/dev_tools/task_wrapper.py`

### Checkpoint Files
- **Location:** `.artifacts/*.json`
...
### Documentation
- **This guide:** `.project/dev_tools/MULTI_ACCOUNT_RECOVERY_GUIDE.md`
- **Task wrapper usage:** `.project/dev_tools/TASK_WRAPPER_USAGE.md`
- **Checkpoint system design:** `.project/ai/config/agent_checkpoint_system.md`
...
```bash
bash .project/dev_tools/recover_project.sh
cat .project/ai/planning/CURRENT_STATUS.md
```
...
cat .artifacts/<task>_<agent>_progress.json
```
...
All agent progress, deliverables, and outputs are saved in `.artifacts/`.
...
**Location:** `.project/dev_tools/MULTI_ACCOUNT_RECOVERY_GUIDE.md`
