...
**File:** `.project/dev_tools/launch-checkpoint-task.bat`
...
**File:** `.project/dev_tools/LAUNCH_TEMPLATE.bat`
...
**File:** `.project/dev_tools/EXAMPLES-launch-checkpoint.bat`
...
4. Save as `my-task-name.bat` in `.project/dev_tools/`
...
**Questions?** See `.project/dev_tools/QUICK_START_CHECKPOINT.md` for more details.
