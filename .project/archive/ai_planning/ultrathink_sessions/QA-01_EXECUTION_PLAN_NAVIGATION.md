...
2. ACCURACY (30 min)
   - Verify file count claims (985 total, 814 in docs/, 171 in .project/)
...
### If Score ≥ 85
- [AI] Commit deliverables to `.artifacts/qa_audits/QA-01_NAVIGATION_AUDIT_[DATE].md`
- [AI] Update `.project/ai/planning/CURRENT_STATUS.md`
...
- [ ] Raw metrics JSON exported to `.artifacts/`
