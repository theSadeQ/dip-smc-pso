...
- CA-01 Audit: `.artifacts/qa_audits/CA-01_CONTROLLER_SIMULATION_AUDIT/CA-01_FINAL_AUDIT_REPORT.md`
- Memory Management Config: `.project/ai/config/controller_memory.md`
