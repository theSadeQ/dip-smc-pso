...
- **Analysis Document**: `.project/ai/guides/docs_structure_analysis.md` (comprehensive analysis)
- **Execution Plan**: `.project/ai/guides/docs_reorganization_execution_plan.md` (detailed plan)
- **Workspace Organization**: `.project/ai/guides/workspace_organization.md` (broader context)
