...
- Theory documents:
  ...
  * LT-7 research paper (.artifacts/research_paper/v2.1/) - Section 3.4 Hybrid Adaptive STA-SMC
...
stat .artifacts/research_paper/v2.1/  # LT-7 paper
...
- [ ] Commit audit deliverables to `.artifacts/qa_audits/MA-02_HYBRID_ADAPTIVE_STA_SMC_2025-11-10/`
- [ ] Update `.project/ai/planning/CURRENT_STATUS.md`
