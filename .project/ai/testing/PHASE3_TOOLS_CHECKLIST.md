...
python -m pytest tests/test_core/ --json-report --json-report-file=.artifacts/test_verify.json -q
ls -lh .artifacts/test_verify.json
rm .artifacts/test_verify.json
