# .project/ai - AI Configuration & Documentation
...
**Integration**: Used by `.project/tools/checkpoints/` for crash recovery
...
**See**: `.project/ai/education/README.md` for complete learning paths
...
python .project/tools/checkpoints/agent_checkpoint.py --help
```

### Learning Path
```bash
# Start beginner roadmap (Path 0)
cat .project/ai/education/beginner-roadmap.md

# Generate NotebookLM podcast
cat .project/ai/education/notebooklm_guide.md

# Browse episode guides
ls .project/ai/education/notebooklm/episode_guides/phase4/
```
...
cat .project/ai/planning/research/ROADMAP_EXISTING_PROJECT.md

# Phase 3 handoff
cat .project/ai/planning/phase3/HANDOFF.md
```
...
- `.project/ai/config/` (orchestration, guides) -> `ai/orchestration/`, `ai/guides/`
- `.project/ai/edu/` -> `ai/education/`
- `.project/ai/qa/` -> `ai/quality/`
- `.project/ai/planning/` (merged with `.project/planning/`) -> `ai/planning/`
