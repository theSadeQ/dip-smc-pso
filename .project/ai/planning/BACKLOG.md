...
**Issue:** logs/ directory still exists at root (should be .logs/ per Dec 17 reorganization)
...
- [ ] Investigate pso_results.db lock and migrate logs/ → .logs/ when process releases
