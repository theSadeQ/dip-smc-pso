...
python .artifacts/qa_audits/qa_audit_staged_files.py
...
- name: QA Audit on PR
  run: python .artifacts/qa_audits/qa_audit_pr_files.py
...
python .artifacts/qa_audits/generate_qa_dashboard.py
...
python .artifacts/qa_audits/auto_fix_readability.py --file README.md
