...
"""
======================================================================================
FILE: .project/tools/migration/migrate_docs_structure.py
...
def move_scripts():
    """Move validation and utility scripts to .project/tools/."""
    ...
    for file in VALIDATION_SCRIPTS:
        source = f"docs/{file}"
        destination = f".project/tools/validation/docs/{file}"
    ...
    for file in UTILITY_SCRIPTS:
        source = f"docs/{file}"
        destination = f".project/tools/docs/{file}"
