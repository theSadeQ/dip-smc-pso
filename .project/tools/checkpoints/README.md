# .project/tools/checkpoints - Agent Checkpoint System
...
**Output Location**: `.project/checkpoints/{task_id}_{agent_id}_{timestamp}.json`

**See**: `.project/ai/orchestration/agent_checkpoint_system.md` for complete API
...
- Output preservation (saves to `.artifacts/`)
...
ls .artifacts/LT4_research_paper/
```
...
# 3. Review deliverables in .artifacts/
ls .artifacts/
...
git add .project/checkpoints/ && git commit -m "checkpoint: agent progress"
git push
...
**See**: `.project/tools/multi_account/TASK_WRAPPER_USAGE.md`
...
**See**: `.project/ai/orchestration/agent_orchestration.md`
...
- `agent_checkpoint.py` from `.project/dev_tools/`
- `analyze_checkpoints.py` from `.project/dev_tools/`
- `launch_checkpoint_task.py` from `.project/dev_tools/`
- `checkpoint_manager.py` from `.project/dev_tools/research/`

**Checkpoint Location**: `.project/checkpoints/` (unchanged)
