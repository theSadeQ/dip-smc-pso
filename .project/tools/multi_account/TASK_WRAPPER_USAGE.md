...
# Or use full path
import sys
sys.path.insert(0, '.project/dev_tools')
...
- Preserves all partial work from `.artifacts/`
...
ls -la .artifacts/lt4_agent1_theory_complete.json
...
All checkpoints are stored in `.artifacts/`:
...
```bash
# View agent progress
cat .artifacts/lt4_agent1_theory_progress.json

# View output
cat .artifacts/lt4_agent1_theory_output.json
...
ls -la .artifacts/*_launched.json
...
result = checkpoint_task_launch(
    ...
    task_config={
        ...
        Output: .artifacts/LT-7_research_paper.pdf
        """
    },
