...
This project builds upon decades of research in control theory, optimization, and software engineering. We provide comprehensive attribution across three domains:

1. **Software Dependencies & Licenses** → [DEPENDENCIES.md](DEPENDENCIES.md)
...
**Citing This Project's Control Theory:**
```bibtex
...
- **Numba** (BSD) - Lam et al. (2015) - JIT compilation
...
- **Dependency Injection** - Seemann (2011) - Throughout

See [PATTERNS.md](PATTERNS.md) for complete pattern analysis.

---

## Citation Breakdown by Domain

### 1. Control Theory & Algorithms

| Topic | Key Citations | Implementation |
|-------|---------------|----------------|
...
| **PSO Optimization** | Kennedy & Eberhart (1995), Clerc & Kennedy (2002) | `src/optimizer/pso_optimizer.py` |

Full details: [CITATIONS_ACADEMIC.md](CITATIONS_ACADEMIC.md#1-sliding-mode-control-theory)

---

### 2. Software Engineering & Architecture

| Pattern/Tool | Citation | Usage |
|--------------|----------|-------|
...
| **Type Hints (PEP 484)** | van Rossum et al. (2014) | 95% coverage |

Full details: [PATTERNS.md](PATTERNS.md#table-of-contents)

---

### 3. Scientific Computing Libraries

| Library | License | Citation | Purpose |
|---------|---------|----------|---------|
...
| **Numba** | BSD-2 | Lam et al. (2015) | JIT compilation |

Full details: [DEPENDENCIES.md](DEPENDENCIES.md#core-numerical--scientific-libraries)
...
| Domain | Items Cited | Document | Word Count |
|--------|-------------|----------|------------|
...
| **Licenses** | 10 unique licenses | [LICENSES.md](LICENSES.md) | 8,000 |

**Total:** 50,000+ words of attribution documentation

---

### Citation Quality Metrics

**Academic References ([CITATIONS_ACADEMIC.md](CITATIONS_ACADEMIC.md)):**
- Primary sources: 85% (33/39)
- Recent work (<10 years): 35% (14/39)
- DOI availability: 75% (29/39)
- Peer-reviewed journals: 55% (22/39)

**Software Attribution ([DEPENDENCIES.md](DEPENDENCIES.md)):**
- License compliance: 100% (all verified)
- Academic papers: 90% (27/30 libraries)
- Version pinned: 100% (reproducibility)
...
**For control theory contributions:**
```bibtex
@software{dip_smc_pso_2025,
  ...
  note={Implements classical SMC, super-twisting, adaptive, and hybrid controllers
        with PSO-based gain tuning. See CITATIONS_ACADEMIC.md for theoretical foundations.}
}
```
...
See DEPENDENCIES.md for complete attribution.
```
...
- Dependency Injection: Seemann (2011) - DI in .NET
...
- **Python-specific:** PSF (5%)

No GPL dependencies - safe for proprietary derivatives.

Full analysis: [LICENSES.md](LICENSES.md)
...
1. **Understand SMC theory** → [CITATIONS_ACADEMIC.md](CITATIONS_ACADEMIC.md#1-sliding-mode-control-theory)
...
**When to update citation documents:**
...
4. License changes → Update [LICENSES.md](LICENSES.md)

### Verification Checklist

- [ ] All theoretical claims have academic citations
...
- Check the specific attribution document ([DEPENDENCIES.md](DEPENDENCIES.md), [PATTERNS.md](PATTERNS.md), or [CITATIONS_ACADEMIC.md](CITATIONS_ACADEMIC.md))

**Found missing attribution?**
