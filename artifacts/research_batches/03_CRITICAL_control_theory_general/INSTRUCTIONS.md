# Step-by-Step Instructions - Batch 03_CRITICAL_control_theory_general
...
- Prompt: `D:\Projects\main\artifacts\research_batches\03_CRITICAL_control_theory_general\PROMPT.md`
...
2. It will generate citations for all 3 claims
3. **IMPORTANT:** As soon as response appears:
   - Select entire response (Ctrl+A)
   - Copy to notepad (Ctrl+C → Ctrl+V)
   - Save as backup: `batch_03_CRITICAL_control_theory_general_response.txt`
...
## Step 4: Fill CSV for Each Claim (3 claims × 2-3 min = 7 min)
...
- [ ] All 3 claims have `Research_Status = "completed"`
- [ ] All 3 claims have 6 tracking columns filled (no blanks)
- [ ] ChatGPT response backed up to text file
- [ ] Progress tracker shows batch 100% complete
- [ ] CSV saved successfully

**Time Estimate vs Actual:**
- **Estimated:** 0.8 hours (45 min)
...
- **Next folder:** `04_03_CRITICAL_control_theory/`
- **Location:** `D:\Projects\main\artifacts\research_batches\04_03_CRITICAL_control_theory/`
