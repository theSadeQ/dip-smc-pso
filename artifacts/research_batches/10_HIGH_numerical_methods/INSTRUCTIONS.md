# Step-by-Step Instructions - Batch 10_HIGH_numerical_methods
...
- Prompt: `D:\Projects\main\artifacts\research_batches\10_HIGH_numerical_methods\PROMPT.md`
...
2. It will generate citations for all 20 claims
3. **IMPORTANT:** As soon as response appears:
   - Select entire response (Ctrl+A)
   - Copy to notepad (Ctrl+C → Ctrl+V)
   - Save as backup: `batch_10_HIGH_numerical_methods_response.txt`
...
## Step 4: Fill CSV for Each Claim (20 claims × 2-3 min = 50 min)
...
- [ ] All 20 claims have `Research_Status = "completed"`
- [ ] All 20 claims have 6 tracking columns filled (no blanks)
- [ ] ChatGPT response backed up to text file
- [ ] Progress tracker shows batch 100% complete
- [ ] CSV saved successfully

**Time Estimate vs Actual:**
- **Estimated:** 4.0 hours (240 min)
...
- **Next folder:** `11_10_HIGH_numerical/`
- **Location:** `D:\Projects\main\artifacts\research_batches\11_10_HIGH_numerical/`
