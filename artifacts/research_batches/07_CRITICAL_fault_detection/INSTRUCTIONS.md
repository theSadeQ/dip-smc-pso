# Step-by-Step Instructions - Batch 07_CRITICAL_fault_detection
...
- Prompt: `D:\Projects\main\artifacts\research_batches\07_CRITICAL_fault_detection\PROMPT.md`
...
2. It will generate citations for all 1 claims
3. **IMPORTANT:** As soon as response appears:
   - Select entire response (Ctrl+A)
   - Copy to notepad (Ctrl+C → Ctrl+V)
   - Save as backup: `batch_07_CRITICAL_fault_detection_response.txt`
...
## Step 4: Fill CSV for Each Claim (1 claims × 2-3 min = 2 min)
...
⏱️ **Total for 1 claims:** ~2 minutes
...
- [ ] All 1 claims have `Research_Status = "completed"`
- [ ] All 1 claims have 6 tracking columns filled (no blanks)
- [ ] ChatGPT response backed up to text file
- [ ] Progress tracker shows batch 100% complete
- [ ] CSV saved successfully

**Time Estimate vs Actual:**
- **Estimated:** 0.2 hours (15 min)
...
- **Next folder:** `08_07_CRITICAL_fault/`
- **Location:** `D:\Projects\main\artifacts\research_batches\08_07_CRITICAL_fault/`
