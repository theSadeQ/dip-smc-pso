# Step-by-Step Instructions - Batch 08_HIGH_implementation_general
...
- Prompt: `D:\Projects\main\artifacts\research_batches\08_HIGH_implementation_general\PROMPT.md`
...
2. It will generate citations for all 314 claims
3. **IMPORTANT:** As soon as response appears:
   - Select entire response (Ctrl+A)
   - Copy to notepad (Ctrl+C → Ctrl+V)
   - Save as backup: `batch_08_HIGH_implementation_general_response.txt`
...
## Step 4: Fill CSV for Each Claim (314 claims × 2-3 min = 785 min)
...
- [ ] All 314 claims have `Research_Status = "completed"`
- [ ] All 314 claims have 6 tracking columns filled (no blanks)
- [ ] ChatGPT response backed up to text file
- [ ] Progress tracker shows batch 100% complete
- [ ] CSV saved successfully

**Time Estimate vs Actual:**
- **Estimated:** 62.8 hours (3768 min)
...
- **Next folder:** `09_08_HIGH_implementation/`
- **Location:** `D:\Projects\main\artifacts\research_batches\09_08_HIGH_implementation/`
