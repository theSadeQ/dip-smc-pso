...
**Batch ID:** 06_CRITICAL_sliding_mode_super_twisting
**Priority:** CRITICAL
...
|---|----------|------|-------------|
| 1 | FORMAL-THEOREM-020 | theorem | The classical SMC law {eq}`eq:classical_smc_structure` with ... |
| 2 | FORMAL-THEOREM-021 | theorem | The super-twisting algorithm ensures finite-time convergence... |
...
**Next batch:** `07_06_CRITICAL_sliding_mode_super/`
