# Step-by-Step Instructions - Batch 06_CRITICAL_sliding_mode_super_twisting
...
- Prompt: `D:\Projects\main\artifacts\research_batches\06_CRITICAL_sliding_mode_super_twisting\PROMPT.md`
...
2. It will generate citations for all 2 claims
3. **IMPORTANT:** As soon as response appears:
   - Select entire response (Ctrl+A)
   - Copy to notepad (Ctrl+C → Ctrl+V)
   - Save as backup: `batch_06_CRITICAL_sliding_mode_super_twisting_response.txt`
...
## Step 4: Fill CSV for Each Claim (2 claims × 2-3 min = 5 min)
...
⏱️ **Total for 2 claims:** ~5 minutes
...
- [ ] All 2 claims have `Research_Status = "completed"`
- [ ] All 2 claims have 6 tracking columns filled (no blanks)
- [ ] ChatGPT response backed up to text file
- [ ] Progress tracker shows batch 100% complete
- [ ] CSV saved successfully

**Time Estimate vs Actual:**
- **Estimated:** 0.5 hours (30 min)
...
- **Next folder:** `07_06_CRITICAL_sliding_mode_super/`
- **Location:** `D:\Projects\main\artifacts\research_batches\07_06_CRITICAL_sliding_mode_super/`
