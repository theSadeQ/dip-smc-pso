# Step-by-Step Instructions - Batch 13_HIGH_pso_optimization
...
- Prompt: `D:\Projects\main\artifacts\research_batches\13_HIGH_pso_optimization\PROMPT.md`
...
2. It will generate citations for all 16 claims
3. **IMPORTANT:** As soon as response appears:
   - Select entire response (Ctrl+A)
   - Copy to notepad (Ctrl+C → Ctrl+V)
   - Save as backup: `batch_13_HIGH_pso_optimization_response.txt`
...
## Step 4: Fill CSV for Each Claim (16 claims × 2-3 min = 40 min)
...
- [ ] All 16 claims have `Research_Status = "completed"`
- [ ] All 16 claims have 6 tracking columns filled (no blanks)
- [ ] ChatGPT response backed up to text file
- [ ] Progress tracker shows batch 100% complete
- [ ] CSV saved successfully

**Time Estimate vs Actual:**
- **Estimated:** 3.2 hours (192 min)
...
- **Next folder:** `14_13_HIGH_pso/`
- **Location:** `D:\Projects\main\artifacts\research_batches\14_13_HIGH_pso/`
