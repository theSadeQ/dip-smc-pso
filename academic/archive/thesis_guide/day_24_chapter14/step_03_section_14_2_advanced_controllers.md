# Step 3: Write Section 14.2 - Advanced Controllers

**Time**: 2 hours
**Output**: Section 14.2 (2 pages)
**Source**: Literature on Terminal SMC, Integral SMC

---

## OBJECTIVE

Describe 3 advanced SMC variants worth investigating
...
```
Write Section 14.2 (2 pages) for the thesis.
...
Proceed to: `step_04_section_14_3_mpc_integration.md`
