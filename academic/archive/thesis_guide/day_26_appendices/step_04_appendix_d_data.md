# Step 4: Appendix D - Extended Data Tables

**Time**: 1.5 hours
**Output**: Appendix D (3 pages)
...
Include full experimental data tables not in main chapters
...
```
Write Appendix D (3 pages) for the thesis.
...
Proceed to: `step_05_appendix_e_user_guide.md`
