# Step 1: Appendix A - Code Listings

**Time**: 2 hours
**Output**: Appendix A (3-4 pages)
...
Select 3-4 key controller implementations to include as code listings
...
```
Write Appendix A (3-4 pages) for the thesis.
...
Proceed to: `step_02_appendix_b_derivations.md`
