# Step 1: Full Thesis Compilation

**Time**: 1 hour
**Output**: Complete PDF (all chapters)
**Source**: All thesis files

---

## OBJECTIVE

Run complete build pipeline from scratch
...
```
Write Complete PDF (all chapters) for the thesis.
...
Proceed to: `step_02_check_page_count.md`
