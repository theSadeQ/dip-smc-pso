# Step 5: Backup All Files

**Time**: 0.5 hours
**Output**: Triple backup complete
**Source**: Entire thesis project

---

## OBJECTIVE

Create 3 backups: local, cloud, external drive
...
```
Write Triple backup complete for the thesis.
...
Proceed to: `step_06_celebrate.md`
