...
**Time**: 0.5 hours
**Output**: Rendered bibliography
**Source**: Formatted .bib file

---

## OBJECTIVE

Run pdflatex + bibtex + pdflatex pipeline
...
```
Write Rendered bibliography for the thesis.
...
Proceed to: `step_05_verify_citations.md`
