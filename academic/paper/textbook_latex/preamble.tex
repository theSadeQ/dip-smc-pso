...
% IMPORTANT: hyperref must be loaded LAST
\usepackage[
    colorlinks=true,
    ...
    pdftitle={Sliding Mode Control of Underactuated Systems},
    pdfauthor={[Author Name]},
    pdfsubject={Control Theory, Robotics},
    pdfkeywords={Sliding Mode Control, PSO, Double Inverted Pendulum}
]{hyperref}

% cleveref for smart cross-references (e.g., "Figure 2.3" instead of "2.3")
\usepackage[capitalize,nameinlink]{cleveref}

% Custom cleveref labels
...
%%% CODE REFERENCES %%%
% For referencing Python files/functions with line numbers
\newcommand{\coderef}[2]{%
