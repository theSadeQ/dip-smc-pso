...
\begin{enumerate}
    ...
    \item \textbf{No Disturbances:} Simulations assume perfect model, no external forces. \cref{ch:advanced_topics} evaluates robustness under disturbances and model uncertainty.
...
\textbf{Recommendation:} \cref{ch:pso_results} re-evaluates performance after PSO gain optimization to isolate algorithmic properties from gain selection effects. \cref{ch:case_studies} presents real-world validation through hardware-in-the-loop experiments.
