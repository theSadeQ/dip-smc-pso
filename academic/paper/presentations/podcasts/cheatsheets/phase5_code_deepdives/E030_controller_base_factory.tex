...
% TITLE PAGE
% ==============================================================================
\makeepisodetitle{E030: Controller Base Classes \& Factory}{Understanding the Foundation: How 7 Controllers Share One Interface}{5A}{25-30 minutes}
...
\begin{itemize}
    ...
    \item Testing = nightmare (7 different APIs)
\end{itemize}
\end{warning}
...
\begin{itemize}
    ...
    \item Testing = same harness for all 7
\end{itemize}
\end{tip}
...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[process, fill=warning!20, below=3.5cm of adaptive] (mpc) {\textbf{MPC (experimental)}};
...
\begin{keypoint}
\textbf{Problem:} How do you create 7 different controller types from configuration without massive if/else chains?
...
# Controller selection (CHANGE THIS ONE LINE to swap algorithms!)
controller_type: 'sta_smc'  # Try: classical_smc, adaptive_smc, hybrid_adaptive_sta_smc
...
gains:
  classical_smc: [10.0, 5.0, 8.0, 3.0, 15.0, 2.0]  # [k1, k2, lam1, lam2, K, kd]
...
\begin{summary}
\textbf{1. Interface Unity}: \texttt{ControllerInterface} enforces contract - all 7 controllers implement \texttt{compute\_control()}
