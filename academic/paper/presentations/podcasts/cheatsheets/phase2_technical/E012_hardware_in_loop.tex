...
\textbf{Why?}
\begin{enumerate}
    \item Sensor noise (real encoders: ±0.1° jitter, not perfect measurements)
    \item Actuator dynamics (motors have inertia, backlash, saturation)
    \item Computational delays (real-time OS scheduling: 1-5ms latency)
    \item Model mismatches (friction, air resistance, cable stiffness)
\end{enumerate}
