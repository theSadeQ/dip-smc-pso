...
\begin{itemize}
    \item \textbf{1.} \textbf{Classical SMC}: Baseline performance
    \item \textbf{2.} \textbf{Super-Twisting}: Notice smoother control?
    \item \textbf{3.} \textbf{Adaptive SMC}: Watch gains adjust in real-time
\end{itemize}
