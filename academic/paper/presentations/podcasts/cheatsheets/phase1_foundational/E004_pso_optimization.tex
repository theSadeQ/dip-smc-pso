...
\begin{itemize}
    \item \textbf{1.} Best spot THEY found (personal memory)
    \item \textbf{2.} Best spot ANYONE found (social/global info)
    \item \textbf{3.} Current flight direction (momentum)
\end{itemize}
...
\textbf{Three Forces:}
\begin{itemize}
    \item \textbf{1.} \textbf{Inertia:} Small push RIGHT ($+0.35$) - 70\% of current momentum
    \item \textbf{2.} \textbf{Cognitive:} Moderate pull LEFT (toward 14.8) - random factor 0.42
    \item \textbf{3.} \textbf{Social:} STRONG pull LEFT (toward 14.5) - random factor 0.78 (nearly max!)
\end{itemize}
...
\begin{itemize}
    \item \textbf{1.} \textbf{Accuracy}: Keep angles at zero (tracking grade)
    \item \textbf{2.} \textbf{Efficiency}: Minimize force/energy (energy grade)
    \item \textbf{3.} \textbf{Smoothness}: Avoid chattering (smoothness grade)
    \item \textbf{4.} \textbf{Stability}: Don't blow up! (Pass/Fail test)
\end{itemize}
\end{keypoint}
...
\textbf{Why minimize?}
\begin{itemize}
    \item \textbf{1.} Hardware limits (motors have max torque)
    \item \textbf{2.} Energy efficiency (battery life)
    \item \textbf{3.} Safety (aggressive control damages equipment)
    \item \textbf{4.} Overfitting prevention
\end{itemize}
...
\textbf{Performance:}
\begin{itemize}
    \item \textbf{1.} Use vectorized simulation for particle evaluation (10-100x speedup)
    \item \textbf{2.} Parallelize across CPU cores (near-linear scaling)
    \item \textbf{3.} Use Simplified model for PSO, validate with Full model
\end{itemize}
