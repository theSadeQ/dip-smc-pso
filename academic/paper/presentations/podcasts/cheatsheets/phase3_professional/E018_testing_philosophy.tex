...
\begin{tikzpicture}[node distance=1.5cm]
    \node[block, fill=accent!30] (e2e) {\textbf{E2E}\\Few\\Slow};
    \node[process, below=of e2e] (integration) {\textbf{Integration}\\Some\\Medium};
    \node[block, fill=secondary!30, below=of integration] (unit) {\textbf{Unit}\\Many\\Fast};

    \draw[arrow] (unit) -- (integration);
    \draw[arrow] (integration) -- (e2e);
\end{tikzpicture}
\end{center}
\begin{itemize}
