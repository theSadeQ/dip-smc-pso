# Step 5: Detect AI Patterns

**Time**: 1 hour
**Output**: AI pattern report
...
Run detect_ai_patterns.py, fix conversational language
...
```
Write AI pattern report for the thesis.
...
Proceed to: `step_06_final_read_through.md`
