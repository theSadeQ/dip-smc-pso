# Step 6: Compile All Appendices

**Time**: 0.5 hours
**Output**: All appendices compiled
**Source**: All appendix files

---

## OBJECTIVE

Compile appendices, verify formatting, check references
...
```
Write All appendices compiled for the thesis.
...
Proceed to: Day 27 - Bibliography
