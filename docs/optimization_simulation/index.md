# Optimization & Simulation Documentation
...
This section provides comprehensive documentation for the optimization algorithms (PSO) and simulation infrastructure used for controller gain tuning and performance evaluation.
...
```{toctree}
:maxdepth: 2
:caption: Optimization & Simulation

guide
```

**Comprehensive Optimization & Simulation Guide**
...
- **P_fail**: Graded instability penalty

### Integration Methods

| Method | Order | Stability | Cost per Step | Use Case |
|--------|-------|-----------|---------------|----------|
| **Explicit Euler** | 1 | Conditional | 1× | Real-time, PSO optimization |
| **RK4** | 4 | Better | 4× | High-accuracy research |
| **Adaptive RK45** | 4-5 | Excellent | Variable | Energy conservation validation |
...
- **Eliminates 423+ copies** in typical 5-second simulation
...
- **{doc}`../controllers/index`** - SMC controllers for PSO optimization
