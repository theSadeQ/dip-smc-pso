...
8. [Examples](#examples) --- ## Core Factory Functions ### `create_controller()` **Primary factory function for creating controller instances.** ```python
