...
| **Code Examples** | 5 | 5 | 2 () |  Fewer but more detailed |
| **Code Example Lines** | ~600 | ~800 | ~310 (2 examples) |  Proportional to count |
...
| **Code examples** | 5 (executable) | 2 (, validated) |  PARTIAL (pattern established) |
