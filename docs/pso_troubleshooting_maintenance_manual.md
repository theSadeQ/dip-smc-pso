...
validation_result = validator.validate_config('config.yaml') if validation_result['schema_valid']: print(" Configuration is valid") if validation_result['warnings']: print(" Warnings:") for warning in validation_result['warnings']: print(f" - {warning}")
