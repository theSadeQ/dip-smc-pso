...
##### `__init__(self, gains, max_force, dt)`

[View full source →](#method-smcconfig-__init__)
...
##### `__init__(self, controller, n_gains, controller_type)`

[View full source →](#method-psocontrollerwrapper-__init__)

##### `_add_step_method_to_dynamics(self)`

Add step method to dynamics model for simulation compatibility.

[View full source →](#method-psocontrollerwrapper-_add_step_method_to_dynamics)

##### `validate_gains(self, particles)`
...
##### `__init__(self, gain_names, gain_bounds, controller_type, n_gains)`

[View full source →](#method-smcgainspec-__init__)
