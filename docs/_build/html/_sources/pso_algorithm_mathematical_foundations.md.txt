...
where $P_{\text{base}}$ is a large penalty constant.
...
## 8. Numerical Stability and Implementation Considerations
...
where $C$ is a problem-dependent constant and $\rho \in (0,1)$ depends on PSO parameters.
