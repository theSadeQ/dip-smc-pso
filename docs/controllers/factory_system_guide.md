...
**Advanced Factory Pattern Documentation** --- ## Table of Contents 1. [Overview](#overview)
...
10. [Troubleshooting](#troubleshooting) --- ## 1. Overview ### 1.1 Purpose The Factory System provides a unified, type-safe interface for instantiating SMC controllers with: - **PSO parameter tuning** - Array-based parameter injection
...
| **Hybrid Adaptive-STA SMC** | 4 | Combined adaptive + STA | --- ## 2. Architecture ### 2.1 Design Principles ```python
# example-metadata:
...
- Study [Classical SMC Technical Guide](classical_smc_technical_guide.md) for controller details --- **Document Version:** 1.0
