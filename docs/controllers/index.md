# Controllers Module Documentation **documentation for sliding mode controllers, factory system, and control primitives**

## Overview This section provides complete documentation for the DIP_SMC_PSO controllers module, including: - **Technical Guides**: In-depth controller implementation and theory
...
## 📚 Technical Guides ### Core SMC Controllers technical guides for each sliding mode controller variant: ```{toctree}
...
## 🔬 Mathematical Foundations ```{toctree}
:maxdepth: 2
...
## 📖 API Reference Complete Python API documentation for all controller modules: ```{toctree}
...
## Quick Reference ### Controller Selection Guide | Controller Type | Best For | Convergence | Chattering | Complexity |
|----------------|----------|-------------|------------|------------|
...
- Optimization/Simulation Infrastructure (PSO, batch simulation, configuration) **Total Documentation**: ~12,000+ lines of research-grade technical content

---

## Related Documentation - **{doc}`../theory_overview`** - High-level control theory overview
...
## Contributing For guidelines on extending controllers or adding new features, see:
