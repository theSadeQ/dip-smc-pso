...
- Persistent checkpoint files in `academic/`
...
RECOMMENDATION:
  ...
  Check academic/*_launched.json for details.
...
3. **No distributed agent support**
   - Assumes single machine, local academic/
...
- Cloud sync (sync academic/ to GitHub/Dropbox)
