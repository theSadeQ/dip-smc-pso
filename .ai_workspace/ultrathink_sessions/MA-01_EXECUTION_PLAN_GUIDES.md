...
"""
# Usage: python academic/scripts/collect_guides_inventory.py
```
...
"""
# Usage: python academic/scripts/calculate_file_metrics.py docs/guides/getting-started.md
```
...
"""
# Usage: python academic/scripts/batch_guides_metrics.py
```
...
"""
# Usage: python academic/scripts/validate_guides_links.py
```
...
"""
# Usage: python academic/scripts/check_guides_terminology.py
```
...
"""
# Usage: python academic/scripts/analyze_guides_gaps.py
```
...
- [AI] Commit all deliverables to `academic/qa_audits/MA-01_GUIDES_AUDIT_2025-11-10/`
- [AI] Update `.ai_workspace/planning/CURRENT_STATUS.md` with audit results
...
git add academic/qa_audits/MA-01_GUIDES_AUDIT_2025-11-10/
git add .ai_workspace/ultrathink_sessions/MA-01_EXECUTION_PLAN_GUIDES.md
...
- [ ] All deliverables committed to `academic/qa_audits/MA-01_GUIDES_AUDIT_2025-11-10/`
