...
Usage:
    python .ai_workspace/dev_tools/cleanup_test_checkpoints.py              # Dry run
    python .ai_workspace/dev_tools/cleanup_test_checkpoints.py --execute    # Actually delete
    python .ai_workspace/dev_tools/cleanup_test_checkpoints.py --all        # Clean ALL checkpoints (risky!)
"""
...
def cleanup_test_checkpoints(execute: bool = False, clean_all: bool = False):
    ...
    if execute:
        ...
        if clean_all:
            print('  python .ai_workspace/dev_tools/cleanup_test_checkpoints.py --all --execute')
        else:
            print('  python .ai_workspace/dev_tools/cleanup_test_checkpoints.py --execute')
