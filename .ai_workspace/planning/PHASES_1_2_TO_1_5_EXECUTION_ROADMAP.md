...
**Checkpoint Directory**: `academic/checkpoints/L1P2_LOGGING/`
...
**Checkpoint Directory**: `academic/checkpoints/L1P3_FAULT_INJECTION/`
...
**Checkpoint Directory**: `academic/checkpoints/L1P4_MONITORING/`
...
**Checkpoint Directory**: `academic/checkpoints/L1P5_BASELINES/`
...
```
academic/checkpoints/LEVEL_1_COMPLETE.json
