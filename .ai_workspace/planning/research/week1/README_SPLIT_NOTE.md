...
4. **MT-3: Adaptive inertia PSO** ❌ **FUTURE** (moved to `.ai_workspace/planning/futurework/week1/`)
...
**Moved to** `.ai_workspace/planning/futurework/week1/`:
- `tasks/MT-3.md`
...
- `.ai_workspace/planning/research/ROADMAP_EXISTING_PROJECT.md` (authoritative for existing work)
- `.ai_workspace/planning/futurework/ROADMAP_FUTURE_RESEARCH.md` (authoritative for future work)
...
**See**: `.ai_workspace/planning/futurework/week1/README.md` for MT-3 integration path
