...
- **Restructuring Plan**: `.ai_workspace/dev_tools/RESTRUCTURING_PLAN_2025-10-26.md`
- **ISO 8601 Dates**: https://en.wikipedia.org/wiki/ISO_8601
- **snake_case Reference**: https://en.wikipedia.org/wiki/Snake_case

---

**Questions?** See `.ai_workspace/dev_tools/` or ask the team lead.
