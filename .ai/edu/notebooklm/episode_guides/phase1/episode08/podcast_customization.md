...
```
Create an ultra-detailed, comprehensive discussion covering every aspect of Newton's Laws and Pendulum Physics.

[CUSTOMIZE THIS SECTION WITH EPISODE-SPECIFIC CONTENT]

START with motivation and real-world context explaining WHY Newton's Laws and Pendulum Physics matters. Provide 2-3 paragraphs with concrete examples, real-world applications, what problem this topic solves.

INTRODUCE core concept with extended analogy relating Newton's Laws and Pendulum Physics to physical/everyday experience. Explore the analogy from multiple angles (3-4 paragraphs) making the abstract concept tangible.
...
**File**: `episode_guides/phase1/episode08/podcast_customization.md`
