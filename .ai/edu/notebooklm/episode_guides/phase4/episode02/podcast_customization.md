...
```
Create an ultra-detailed, comprehensive discussion covering every aspect of OOP Foundations.

[CUSTOMIZE THIS SECTION WITH EPISODE-SPECIFIC CONTENT]

START with motivation and real-world context explaining WHY OOP Foundations matters. Provide 2-3 paragraphs with concrete examples, real-world applications, what problem this topic solves.

INTRODUCE core concept with extended analogy relating OOP Foundations to physical/everyday experience. Explore the analogy from multiple angles (3-4 paragraphs) making the abstract concept tangible.
...
**File**: `episode_guides/phase4/episode02/podcast_customization.md`
