...
```
Create an ultra-detailed, comprehensive discussion covering every aspect of Lyapunov Stability and Phase Space.

[CUSTOMIZE THIS SECTION WITH EPISODE-SPECIFIC CONTENT]

START with motivation and real-world context explaining WHY Lyapunov Stability and Phase Space matters. Provide 2-3 paragraphs with concrete examples, real-world applications, what problem this topic solves.

INTRODUCE core concept with extended analogy relating Lyapunov Stability and Phase Space to physical/everyday experience. Explore the analogy from multiple angles (3-4 paragraphs) making the abstract concept tangible.
...
**File**: `episode_guides/phase4/episode13/podcast_customization.md`
