# Step-by-Step Instructions - Batch 16_HIGH_sliding_mode_adaptive
...
- Prompt: `D:\Projects\main\artifacts\research_batches\16_HIGH_sliding_mode_adaptive\PROMPT.md`
...
2. It will generate citations for all 11 claims
3. **IMPORTANT:** As soon as response appears:
   - Select entire response (Ctrl+A)
   - Copy to notepad (Ctrl+C → Ctrl+V)
   - Save as backup: `batch_16_HIGH_sliding_mode_adaptive_response.txt`
...
## Step 4: Fill CSV for Each Claim (11 claims × 2-3 min = 27 min)
...
- [ ] All 11 claims have `Research_Status = "completed"`
- [ ] All 11 claims have 6 tracking columns filled (no blanks)
- [ ] ChatGPT response backed up to text file
- [ ] Progress tracker shows batch 100% complete
- [ ] CSV saved successfully

**Time Estimate vs Actual:**
- **Estimated:** 2.2 hours (132 min)
...
- **Next folder:** `17_16_HIGH_sliding_mode/`
- **Location:** `D:\Projects\main\artifacts\research_batches\17_16_HIGH_sliding_mode/`
