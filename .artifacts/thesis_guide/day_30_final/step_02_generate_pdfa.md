# Step 2: Generate PDF/A for Archiving

**Time**: 1 hour
**Output**: PDF/A compliant file
**Source**: Final PDF
...
Convert to PDF/A format for long-term archiving
...
```
Write PDF/A compliant file for the thesis.
...
Proceed to: `step_03_prepare_defense_slides.md`
