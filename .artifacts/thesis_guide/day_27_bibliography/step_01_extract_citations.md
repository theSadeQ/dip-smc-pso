# Step 1: Extract Citations from All Chapters

**Time**: 1 hour
**Output**: Complete citation list
**Source**: All .tex files

---

## OBJECTIVE

Run extract_bibtex.py to collect all cite commands from thesis
...
```
Write Complete citation list for the thesis.
...
Proceed to: `step_02_organize_by_topic.md`
