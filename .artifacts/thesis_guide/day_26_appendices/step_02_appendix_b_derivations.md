# Step 2: Appendix B - Mathematical Derivations

**Time**: 2 hours
**Output**: Appendix B (4-5 pages)
**Source**: docs/theory/
...
Include detailed derivations omitted from main chapters
...
```
Write Appendix B (4-5 pages) for the thesis.
...
Length: 5 pages (12pt font, 1-inch margins)
```
...
Proceed to: `step_03_appendix_c_parameters.md`
