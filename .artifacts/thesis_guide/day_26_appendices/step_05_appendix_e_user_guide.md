# Step 5: Appendix E - Software User Guide

**Time**: 2 hours
**Output**: Appendix E (3-4 pages)
**Source**: README.md, docs/guides/

---

## OBJECTIVE

Write user guide for running simulations and optimization
...
```
Write Appendix E (3-4 pages) for the thesis.
...
Length: 4 pages (12pt font, 1-inch margins)
```
...
Proceed to: `step_06_compile_appendices.md`
