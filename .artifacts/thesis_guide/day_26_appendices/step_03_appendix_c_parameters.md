# Step 3: Appendix C - Parameter Tables

**Time**: 1 hour
**Output**: Appendix C (2 pages)
**Source**: config.yaml
...
Create comprehensive parameter tables for all controllers
...
```
Write Appendix C (2 pages) for the thesis.
...
Proceed to: `step_04_appendix_d_data.md`
