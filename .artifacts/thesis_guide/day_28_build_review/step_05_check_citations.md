# Step 5: Check Citation Integrity

**Time**: 0.5 hours
**Output**: Citation integrity report
**Source**: Compiled PDF + .log

---

## OBJECTIVE

Verify no undefined citations, bibliography complete
...
```
Write Citation integrity report for the thesis.
...
Proceed to: `step_06_fix_compilation_errors.md`
