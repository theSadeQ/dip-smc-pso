# Step 1: Spell Check Entire Thesis

**Time**: 1.5 hours
**Output**: Spell-checked thesis
**Source**: Complete PDF/tex files

---

## OBJECTIVE

Run spell checker, fix all typos
...
```
Write Spell-checked thesis for the thesis.
...
Proceed to: `step_02_grammar_check.md`
