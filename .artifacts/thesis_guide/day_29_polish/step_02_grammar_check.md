...
**Time**: 2 hours
**Output**: Grammar-checked thesis
**Source**: Spell-checked files

---

## OBJECTIVE

Use Grammarly/LanguageTool for grammar validation
...
```
Write Grammar-checked thesis for the thesis.
...
Proceed to: `step_03_check_consistency.md`
